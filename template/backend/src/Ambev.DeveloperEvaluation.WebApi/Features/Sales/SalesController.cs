...
public class SalesController : BaseController
{
    ...
    public async Task<IActionResult> GetSale([FromRoute] Guid id, CancellationToken cancellationToken)
    {
        ...
        var validator = new GetSales.GetSaleValidator();
        var validationResult = await validator.ValidateAsync(request, cancellationToken);
    ...
    /// </summary>
    [HttpGet]
    [ProducesResponseType(typeof(ApiResponseWithData<IEnumerable<GetSalesResponse>>), StatusCodes.Status200OK)]
    public async Task<IActionResult> GetSales(CancellationToken cancellationToken)
    {
        ...
        return Ok(new ApiResponseWithData<IEnumerable<GetSalesResponse>>
        {
            ...
            Data = _mapper.Map<IEnumerable<GetSalesResponse>>(result)
        });
    }
